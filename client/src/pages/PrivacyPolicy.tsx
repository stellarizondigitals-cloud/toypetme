      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-2"><strong>Usage data via third-party ads:</strong> We use Google AdSense to display advertisements. Google may collect data through cookies and similar technologies, including your IP address, browser type, pages visited, and interests, to serve personalised or contextual ads. We do not control this data collection.</p>
