...
export const ACHIEVEMENTS: {
  ...
  { id: "jump_score_10",     name: "Sky Hopper",        description: "Pass 10+ pipes in Pet Jump",  icon: "🐦", reward: 25 },
  { id: "jump_score_50",     name: "Flap Champion",     description: "Pass 50+ pipes in Pet Jump",  icon: "🏆", reward: 100 },
  { id: "whack_score_10",    name: "Quick Whacker",     description: "Score 10+ in Whack-a-Pet",    icon: "🔨", reward: 25 },
  { id: "whack_score_50",    name: "Whack Master",      description: "Score 50+ in Whack-a-Pet",    icon: "💥", reward: 100 },
  { id: "tiles_score_10",    name: "Tile Pusher",       description: "Score 10+ in 2048 Pets",      icon: "🎯", reward: 25 },
  { id: "tiles_score_50",    name: "Merge Master",      description: "Score 50+ in 2048 Pets",      icon: "🔢", reward: 100 },
  { id: "snake_score_10",    name: "Hungry Snake",      description: "Score 10+ in Snake Feast",    icon: "🐍", reward: 25 },
  { id: "snake_score_50",    name: "Snake Legend",      description: "Score 50+ in Snake Feast",    icon: "🍎", reward: 100 },
  { id: "breakout_score_10", name: "Brick Buster",      description: "Score 10+ in Brick Breaker",  icon: "🧱", reward: 25 },
  { id: "breakout_score_50", name: "Breakout Pro",      description: "Score 50+ in Brick Breaker",  icon: "🎱", reward: 100 },
  { id: "games_1",           name: "First Play",        description: "Play your first mini-game",   icon: "🎮", reward: 20 },
  { id: "games_10",          name: "Gamer",             description: "Play 10 mini-games",          icon: "🕹️", reward: 100 },
  { id: "games_50",          name: "Arcade Legend",     description: "Play 50 mini-games",          icon: "🏆", reward: 300 },
];
